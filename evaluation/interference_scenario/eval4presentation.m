...
xlabel('latency [탎]')
ylabel('CDF')
legend('Congestion','Aggregation','Transmit','Ack','Retry','Location','SouthEast')
...
xlabel('Sequence number')
ylabel('Latency [탎]')
legend('Congestion','Aggregation','Transmit','Ack','Retry','Location','NorthWest')
...
hist_h = histogram(lat_noAck,hist_lat_noAck_x,'Normalization','cdf');
...
hist_h = histogram(lat_ack,hist_lat_ack_x,'Normalization','cdf');
