...
%% EVAL
dest_ip = '192.168.1.1'; %'192.168.1.1'
dest_mac = '00:00:00_00:00:01 (00:00:00:00:00:01) (TA)'; % 00:00:00_00:00:01 (00:00:00:00:00:01) (TA)
% dest_ip = '192.168.1.4';
% dest_mac = '00:00:00_00:00:04 (00:00:00:00:00:04) (TA)';

filen = 'ap1.mat'; % BSS2_results.mat
load(filen); % BSS2_raw.mat
...
% load('BSS1_raw_TXOPcontent_restriction.mat')
